...
export default function InvoicePage() {
  ...
  async function submit(event: {
    ...
    const request = invoiceRequestSchema.safeParse({
    ...
    const details = [
      ...
      ...(items.length
        ? items
        : ['• I will confirm the selected products with the support team.']),
      ...(items.length
        ? [
            '',
  ...
  return (
    <main className="page-shell">
      <header>
        <p className="eyebrow">Invoice checkout</p>
        <h1>Purchase the way your business works.</h1>
        <p>
          Request an invoice for your selected products, contractor purchases,
          or a business order. Final products, delivery, and pricing are
      ...
      <div className="invoice-grid">
        <form className="form-card" onSubmit={submit}>
          ...
          <div className="form-grid">
            ...
            <label>
              City *<input required name="city" autoComplete="address-level2" />
            </label>
            ...
            <label className="wide">
              ...
              <textarea
                name="notes"
                rows={4}
                placeholder="Tell us about the equipment or system you are planning for."
              />
            </label>
          </div>
        ...
        <aside className="aside-card">
          ...
          {items.length ? (
            ...
            <p>
              Add products to your cart and they will be included with this
              invoice request.
            </p>
          )}
          <ol>
            <li>We review your request and selected equipment.</li>
            <li>We confirm availability, delivery, and your final total.</li>
            <li>
              We send an invoice and the selected payment instructions after
              approval.
            </li>
          </ol>
          <div className="invoice-whatsapp">
            ...
            <div>
              <b>Need invoice help?</b>
              <span>Chat with our invoice team on WhatsApp.</span>
            </div>
            <a
              href={whatsappUrl(
                'Hello SolarHome Energy Backup, I need help with an invoice request.',
              )}
              target="_blank"
              rel="noreferrer"
            >
