...
export default function ShopPage() {
  ...
  }).sort((left, right) => left.brand.localeCompare(right.brand) || left.category.localeCompare(right.category) || left.name.localeCompare(right.name));
